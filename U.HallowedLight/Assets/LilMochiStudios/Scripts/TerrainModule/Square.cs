        ...
        private void Triangulate(int configuration) {
            switch (configuration) {
                case 0:
                    break;
                case 1:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_TopCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2 });
                    m_UVs.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_TopCentre });
                    break;
                case 2:
                    m_Vertices.AddRange(new Vector2[] { m_RightCentre, m_BottomRight, m_BottomCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2 });
                    m_UVs.AddRange(new Vector2[] { m_RightCentre, m_BottomRight, m_BottomCentre });
                    break;
                case 3:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_BottomRight, m_BottomCentre, m_TopCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3 });
                    m_UVs.AddRange(new Vector2[] { m_TopRight, m_BottomRight, m_BottomCentre, m_TopCentre });
                    break;
                case 4:
                    m_Vertices.AddRange(new Vector2[] { m_BottomCentre, m_BottomLeft, m_LeftCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2 });
                    m_UVs.AddRange(new Vector2[] { m_BottomCentre, m_BottomLeft, m_LeftCentre });
                    break;
                case 5:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_BottomCentre, m_BottomLeft, m_LeftCentre, m_TopCentre });
                    ...
                    break;
                case 6:
                    m_Vertices.AddRange(new Vector2[] { m_BottomRight, m_BottomLeft, m_LeftCentre, m_RightCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3 });
                    m_UVs.AddRange(new Vector2[] { m_BottomRight, m_BottomLeft, m_LeftCentre, m_RightCentre });
                    break;
                case 7:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_BottomRight, m_BottomLeft, m_LeftCentre, m_TopCentre });
                    ...
                    break;
                case 8:
                    m_Vertices.AddRange(new Vector2[] { m_LeftCentre, m_TopLeft, m_TopCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2 });
                    m_UVs.AddRange(new Vector2[] { m_LeftCentre, m_TopLeft, m_TopCentre });
                    break;
                case 9:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_LeftCentre, m_TopLeft });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3 });
                    m_UVs.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_LeftCentre, m_TopLeft });
                    break;
                case 10:
                    m_Vertices.AddRange(new Vector2[] { m_RightCentre, m_BottomRight, m_BottomCentre, m_LeftCentre, m_TopLeft, m_TopCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3, 0, 3, 4, 0, 4, 5 });
                    m_UVs.AddRange(new Vector2[] { m_RightCentre, m_BottomRight, m_BottomCentre, m_LeftCentre, m_TopLeft, m_TopCentre });
                    break;
                case 11:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_BottomRight, m_BottomCentre, m_LeftCentre, m_TopLeft });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3, 0, 3, 4 });
                    m_UVs.AddRange(new Vector2[] { m_TopRight, m_BottomRight, m_BottomCentre, m_LeftCentre, m_TopLeft });
                    break;
                case 12:
                    m_Vertices.AddRange(new Vector2[] { m_BottomCentre, m_BottomLeft, m_TopLeft, m_TopCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3 });
                    m_UVs.AddRange(new Vector2[] { m_BottomCentre, m_BottomLeft, m_TopLeft, m_TopCentre });
                    break;
                case 13:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_BottomCentre, m_BottomLeft, m_TopLeft });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3, 0, 3, 4 });
                    m_UVs.AddRange(new Vector2[] { m_TopRight, m_RightCentre, m_BottomCentre, m_BottomLeft, m_TopLeft });
                    break;
                case 14:
                    m_Vertices.AddRange(new Vector2[] { m_RightCentre, m_BottomRight, m_BottomLeft, m_TopLeft, m_TopCentre });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3, 0, 3, 4 });
                    m_UVs.AddRange(new Vector2[] { m_RightCentre, m_BottomRight, m_BottomLeft, m_TopLeft, m_TopCentre });
                    break;
                case 15:
                    m_Vertices.AddRange(new Vector2[] { m_TopRight, m_BottomRight, m_BottomLeft, m_TopLeft });
                    m_Triangles.AddRange(new int[] { 0, 1, 2, 0, 2, 3 });
